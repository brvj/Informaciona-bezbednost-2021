...
public class CertificateGenerator {
    ...
    private static SimpleDateFormat iso8601Formatter = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static void generateCertificate(User user) {
        ...
        try {
            startDate = iso8601Formatter.parse("2021-06-06");
            endDate = iso8601Formatter.parse("2022-06-06");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void generateMyRootCA() {
        ...
        nameBuilder.addRDN(BCStyle.CN, "Boris Jankovic");
        nameBuilder.addRDN(BCStyle.SURNAME, "Jankovic");
        nameBuilder.addRDN(BCStyle.GIVENNAME, "Boris");
        nameBuilder.addRDN(BCStyle.O, "UNS");
        nameBuilder.addRDN(BCStyle.OU, "FTN");
        nameBuilder.addRDN(BCStyle.C, "RS");
        nameBuilder.addRDN(BCStyle.E, "jankovicb021@gmail.com");
